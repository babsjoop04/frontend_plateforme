...
const FormChoixPS = ({ change, notificationData, setNotificationData,errors }) => {
  ...
  const changeProduit = (e, type) => {
    ...
    setProduit((prevState) => {
      return { ...prevState, ["type_produit"]: type };
    });
  };
  ...
  const createProduit = () => {
    ...
    setOpenModal(false);
    setOpenModalVaccin(false);
    setOpenModalAutres(false);
  };
    ...
    <>
      <div className="grid grid-cols-1 w-4/5 mx-auto gap-6 px-10 py-10 ">
        ...
        <div className="col-span-full xl:col-span-6 my-3 shadow-sm rounded-xl">
          ...
          <Modal show={openModalVaccin} onClose={() => annulerAjoutProduit()}>
            <Modal.Header>Formulaire d'ajout de produit</Modal.Header>
            <Modal.Body>
              {/*  */}
              <form
        ...
        <div className="col-span-full xl:col-span-6 my-3 shadow-sm rounded-xl">
          <header className="flex justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
            ...
            <Button
              ...
              size="sm"
              onClick={(e) => {
                setOpenModalAutres(true);
                changeProduit(e, "autre");
              }}
          ...
          <Modal show={openModalAutres} onClose={() => annulerAjoutProduit()}>
            <Modal.Header>Formulaire d'ajout de produit</Modal.Header>
            <Modal.Body>
              {/*  */}
              <form
