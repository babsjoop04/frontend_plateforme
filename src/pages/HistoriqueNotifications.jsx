...
import axios from "axios";
import { Button, Card, Dropdown, List, Modal } from "flowbite-react";
import { useAuthProvider } from "../utils/AuthContext";
                  ...
                  <div className="md:flex-1 px-4 ">
                    <div className="mb-4">
                      ...
                      <div className="mb-4 grid grid-cols-2 gap-5  w-full  py-5 mx-auto text-gray-700 dark:text-gray-300">
                        ...
                        {/* <span className="font-bold ">
                          Date de naissance : {selectNotif.}
                        </span> */}
                        {/* <span className="text-gray-600 dark:text-gray-300">hello</span> */}
                        {/* </div> */}
                      </div>
                      {/*  */}
                    </div>
                              ...
                              >
                                ...
                                <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/75">
                                  <div className="w-3/4 text-center md:w-2/4">
                                    ...
                                    <div className="grid grid-cols-2 gap-6 w-full overflow-y-auto   mx-auto">
                                      <div className=" ">
                                        <span className="font-bold ">
                                          Numero de lot :{" "}
                                        </span>
